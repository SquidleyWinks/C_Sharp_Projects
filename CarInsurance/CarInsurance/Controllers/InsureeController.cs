...
namespace CarInsurance.Controllers
{
    public class InsureeController : Controller
    {
        ...
        {
            insuree.Quote = 50;
            int age = (int)((DateTime.Now - insuree.DateOfBirth).TotalDays / 365.242199);
            if (age <= 18) insuree.Quote += 100;
            else if (age >= 19 && age <= 25) insuree.Quote += 50;
            ...
            if (insuree.CarMake.ToLower() == "porsche" && insuree.CarModel.ToLower() == "911 carrera") insuree.Quote += 25;

            insuree.Quote += (insuree.SpeedingTickets * 10);

            if (insuree.DUI == true) insuree.Quote = Decimal.Multiply(insuree.Quote, 1.25m);
            if (insuree.CoverageType == true) insuree.Quote = Decimal.Multiply(insuree.Quote, 1.50m);
